...
class Bert_Embedder:
    ...
    def embed(self,text:str):
        ...
        return (self.model(**tokenizedInput)).last_hidden_state.squeeze(0).tolist()  #last_hidden_state.squeeze(0).tolist
...
class Electra_Embedder:
    ...
    def embed(self,text:str):
        ...
        with torch.no_grad():
            ...
            embeddings = outputs.last_hidden_state.squeeze(0).tolist() #last_hidden_state.mean(dim=1).squeeze().tolist()
